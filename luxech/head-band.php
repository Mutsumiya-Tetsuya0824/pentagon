...
class description_walker extends Walker_Nav_Menu
{
	function start_el(&$output, $item, $depth = 1, $args = array(), $id = 0)
	{
		...
		$blank = ($item->target == '_blank') ? 'target="_blank" rel="noopenner"' : '';
...
<div class="band">
	<div id="head-band<?php echo $band_type; ?>">
		<div class="band-menu">
			...
			// User Custom Menu
			$wp_nav_menu = wp_nav_menu(array('theme_location' => 'head-band', 'echo' => false, 'container' => false,  'fallback_cb' => false, 'items_wrap' => '<div class="headerBox"><ul>%3$s', 'walker' => new Description_Walker()));
			...
			<li class="btnArea">
				<div class="splogo">
					<img src="https://pentagon.conohawing.com/wp-content/uploads/2025/02/logo_h.png" alt="">
				</div>
				<div class="btnList">
					<div><a href="" class="btn_type01">お問い合わせ</a></div>
					<div><a href="" class="btn_type01 bg-w">資料請求</a></div>
				</div>
			</li>
		</ul>
		</div>
